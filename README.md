...
class ShibamKhadanga:
    def __init__(self):
        ...
        self.university  = "Kalinga University, Raipur"
        self.degree      = "B.Tech Computer Science"
        self.location    = "Rourkela, Odisha 🇮🇳"
        self.score_cs    = "94/100 in Class 12 CS 🎯"
    ...
    def stack(self):
        return {
            ...
            "ai_ml"      : ["TensorFlow", "OpenCV", "scikit-learn", "MobileNetV2"],
            "databases"  : ["PostgreSQL", "MySQL", "SQLite"],
            "tools"      : ["Git", "VS Code", "Power BI", "Twilio"],
        }

    def fun_fact(self):
        return "I once cut govt. form processing from 10 min → 3 min 🚀"
```
...
2026 🏆  Finalist      ── NHIDE-2026 National Hackathon, GGV Bilaspur
